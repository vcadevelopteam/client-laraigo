...
import { FieldSelect, OnlyCheckbox, SearchField } from 'components';
...
const CustomTableZyxEditable = React.memo(({
    columns,
    titlemodule,
    fetchData,
    data,
        ...
        if (column.editable) {
            switch (column.type) {
                ...
                case 'boolean':
                    ...
                    />
                default:
                    if(row?.original?.variabletype==="domain"){
                        return <FieldSelect
                            valueDefault={value}
                        ...
                        return <TextField
                            fullWidth
                            value={value}
                            type={row?.original?.variabletype||"string"}
                            onChange={onChange}
                            onBlur={onBlur}
                            inputProps={{ style: {fontSize: '14px'} }}
                        >
...
export default CustomTableZyxEditable;
