...
interface CustomRichTextProps extends Omit<BoxProps, 'onChange'> {
    placeholder?: string;
    spellCheck?: boolean;
    value: Descendant[];
    error?: string;
...
const useCustomRichTextStyles = makeStyles(theme => ({
    toolbar: {
        padding: 0,
        width: "100%"
    },
...
export const CustomRichText: FC<CustomRichTextProps> = ({
    value,
    refresh = 0,
    onChange,
    placeholder,
    ...
    const classes = useCustomRichTextStyles();
...
const ToolBarOptions: React.FC<
    CustomRichTextProps & { editor: BaseEditor & ReactEditor & HistoryEditor; collapsed: boolean }
> = ({ image, onlyurl }) => {
