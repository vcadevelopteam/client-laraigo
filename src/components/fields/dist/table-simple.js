...
var TableZyx = react_1["default"].memo(function (_a) {
    ...
    var _w = react_1.useState([]), columnGroupedBy = _w[0], setColumnGroupedBy = _w[1];
    var _x = react_1.useState(localStorage.getItem('activeColumn') || null), activeColumn = _x[0], setActiveColumn = _x[1];
    var initialColumnVisibility = columns.reduce(function (acc, column) {
        acc[column.id] = true;
        return acc;
    }, {});
    var _y = react_1.useState(function () {
    ...
    }), columnVisibility = _y[0], setColumnVisibility = _y[1];
    ...
    var handleRadioClick = function (columnId) {
        setColumnGroupedBy(function (prevGroupedBy) {
            ...
            prevGroupedBy.forEach(function (prevColumn) {
    ...
    react_1.useEffect(function () {
        var activeColumn = localStorage.getItem('activeColumn');
        if (activeColumn) {
    ...
    var DefaultColumnFilter = function (_a) {
        ...
        var _h = react_1.useState(''), valueOnFocus = _h[0], setValueOnFocus = _h[1]; // El valor cuando el input recibió el foco
        ...
        return (react_1["default"].createElement("div", { style: { display: 'flex', flexDirection: 'row' } }, type === 'boolean' ? (react_1["default"].createElement(exports.BooleanOptionsMenuComponent, { value: value, handleClickItemMenu: handleClickItemMenu }))
            : (type === "select" ?
                ...
                react_1["default"].createElement(react_1["default"].Fragment, null,
                    type === 'date' &&
                        react_1["default"].createElement(exports.DateOptionsMenuComponent, { value: value, handleDate: handleDate }),
                    type === 'time' &&
                        react_1["default"].createElement(exports.TimeOptionsMenuComponent, { value: value, handleTime: handleTime }),
                    !['date', 'time'].includes(type) &&
                        react_1["default"].createElement(Input_1["default"], { onBlur: onBlur, onFocus: function (e) { return setValueOnFocus(e.target.value); }, type: type, style: { fontSize: '15px', minWidth: '100px' }, fullWidth: true, value: value, onKeyDown: keyPress, onChange: function (e) {
    ...
    var _z = react_table_1.useTable({
        ...
        hooks.useInstanceBeforeDimensions.push(function (_a) {
            ...
            var selectionGroupHeader = (_b = headerGroups[0]) === null || _b === void 0 ? void 0 : _b.headers[0];
            if (selectionGroupHeader) {
                selectionGroupHeader.canResize = false;
            }
        });
    }), getTableProps = _z.getTableProps, getTableBodyProps = _z.getTableBodyProps, headerGroups = _z.headerGroups, footerGroups = _z.footerGroups, prepareRow = _z.prepareRow, page = _z.page, // Instead of using 'rows', we'll use page,
    canPreviousPage = _z.canPreviousPage, canNextPage = _z.canNextPage, pageOptions = _z.pageOptions, pageCount = _z.pageCount, gotoPage = _z.gotoPage, nextPage = _z.nextPage, previousPage = _z.previousPage, setPageSize = _z.setPageSize, globalFilteredRows = _z.globalFilteredRows, setGlobalFilter = _z.setGlobalFilter, allColumns = _z.allColumns, _0 = _z.state, pageIndex = _0.pageIndex, pageSize = _0.pageSize, selectedRowIds = _0.selectedRowIds, toggleAllRowsSelected = _z.toggleAllRowsSelected, toggleGroupBy = _z.toggleGroupBy;
    var handleCheckboxChange = function (columnId) {
        var _a;
        var updatedVisibility = __assign(__assign({}, columnVisibility), (_a = {}, _a[columnId] = !columnVisibility[columnId], _a));
        setColumnVisibility(updatedVisibility);
        localStorage.setItem('columnVisibility', JSON.stringify(updatedVisibility));
    };
    react_1.useEffect(function () {
    ...
    var RenderRow = react_1["default"].useCallback(function (_a) {
        ...
        var row = page[index];
        prepareRow(row);
        return (react_1["default"].createElement(TableRow_1["default"], __assign({}, row.getRowProps({ style: style }), { hover: true }), row.cells.map(function (cell, index) {
            var _a;
                    ...
                    react_1["default"].createElement("div", { style: { display: 'flex', gap: 8 } },
                        react_1["default"].createElement(core_1.Popper, { open: openSeButtons, anchorEl: anchorElSeButtons, placement: "bottom", transition: true, style: { marginRight: '1rem' } }, function (_a) {
                            ...
                            return (react_1["default"].createElement(core_1.Paper, __assign({}, TransitionProps, { elevation: 5 }),
                                showHideColumns && (react_1["default"].createElement(react_1["default"].Fragment, null,
                                    react_1["default"].createElement(MenuItem_1["default"], { style: { padding: '0.7rem 1rem', fontSize: '0.96rem' }, onClick: handleOpenShowColumnsModal },
        ...
        isShowColumnsModalOpen && (react_1["default"].createElement(components_1.DialogZyx, { open: isShowColumnsModalOpen, title: t(keys_1.langKeys.showHideColumns), buttonText2: t(keys_1.langKeys.close), handleClickButton2: function () { return setShowColumnsModalOpen(false); }, maxWidth: "sm", buttonStyle1: { marginBottom: '0.3rem' }, buttonStyle2: { marginRight: '1rem', marginBottom: '0.3rem' } },
            react_1["default"].createElement(core_1.Grid, { container: true, spacing: 1, style: { marginTop: '0.5rem' } }, allColumns.filter(function (column) {
                ...
                return (react_1["default"].createElement(core_1.Grid, { item: true, xs: 4, key: column.id },
                    react_1["default"].createElement(core_1.FormControlLabel, { control: react_1["default"].createElement(Checkbox_1["default"], { color: "primary", checked: (_a = columnVisibility[column.id]) !== null && _a !== void 0 ? _a : true, onChange: function (e) { return handleColumnVisibilityChange(column.id, e.target.checked); } }), label: t(column.Header) })));
            })))),
        ...
        react_1["default"].createElement(TableContainer_1["default"], { style: { position: "relative", flex: 1, display: "flex", flexDirection: "column" } },
            react_1["default"].createElement(Box_1["default"], { overflow: "auto", style: { flex: 1 } },
                react_1["default"].createElement(Table_1["default"], __assign({ size: "small" }, getTableProps(), { "aria-label": "enhanced table", "aria-labelledby": "tableTitle" }),
                    react_1["default"].createElement(TableHead_1["default"], { style: { display: 'table-header-group' } }, headerGroups.map(function (headerGroup, index) { return (react_1["default"].createElement(TableRow_1["default"], __assign({}, headerGroup.getHeaderGroupProps(), { key: index, style: useSelection ? { display: 'flex' } : {} }), headerGroup.headers.map(function (column, ii) { return (column.activeOnHover ?
                        ...
                        react_1["default"].createElement(TableCell_1["default"], { key: ii, style: useSelection ? __assign({}, (column.width === 'auto' ? {
                            ...
                            (react_1["default"].createElement(react_1["default"].Fragment, null,
                                react_1["default"].createElement("div", { className: classes.containerHeaderColumn },
                                    activeColumn === column.id && (react_1["default"].createElement(Tooltip_1["default"], { title: '' },
