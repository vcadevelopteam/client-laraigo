...
var TableZyx = react_1["default"].memo(function (_a) {
    ...
    var _j = react_1.useState({ sorts: {}, filters: initialFilters, distinct: "", pageIndex: initialPageIndex }), pagination = _j[0], setPagination = _j[1];
    ...
    }, react_table_1.useColumnOrder, react_table_1.useFilters, react_table_1.useGlobalFilter, react_table_1.useGroupBy, react_table_1.useSortBy, react_table_1.useExpanded, react_table_1.usePagination, react_table_1.useRowSelect, function (hooks) {
    ...
    canPreviousPage = _o.canPreviousPage, canNextPage = _o.canNextPage, pageOptions = _o.pageOptions, pageCount = _o.pageCount, setPageSize = _o.setPageSize, toggleAllRowsSelected = _o.toggleAllRowsSelected, allColumns = _o.allColumns, _p = _o.state, pageIndex = _p.pageIndex, pageSize = _p.pageSize, selectedRowIds = _p.selectedRowIds, setColumnOrder = _o.setColumnOrder;
    ...
    var _v = react_1.useState([]), columnGroupedBy = _v[0], setColumnGroupedBy = _v[1];
    var _w = react_1.useState(false), filterApplied = _w[0], setFilterApplied = _w[1];
    var initialColumnVisibility = allColumns.reduce(function (acc, column) {
        acc[column.id] = true;
        return acc;
    }, {});
    var _x = react_1.useState(function () {
        var storedColumnVisibility = localStorage.getItem('columnVisibility');
    ...
    }), columnVisibility = _x[0], setColumnVisibility = _x[1];
    var handleColumnVisibilityChange = function (columnId, isVisible) {
        var _a;
        var updatedVisibility = __assign(__assign({}, columnVisibility), (_a = {}, _a[columnId] = isVisible, _a));
        setColumnVisibility(updatedVisibility);
        localStorage.setItem('columnVisibility', JSON.stringify(updatedVisibility));
        var columnInstance = allColumns.find(function (column) { return column.id === columnId; });
        if (columnInstance) {
    ...
    react_1.useEffect(function () {
        allColumns.forEach(function (column) {
            var _a;
            var isVisible = (_a = columnVisibility[column.id]) !== null && _a !== void 0 ? _a : true;
    ...
    var handleColumnByToggle = function (column, activate) {
        if (activate === void 0) { activate = true; }
        var columnName = column.id;
        setFilterApplied(false);
        setPagination(function (prev) { return (__assign(__assign({}, prev), { distinct: activate ? columnName : "", filters: {}, pageIndex: 0, trigger: true })); });
        setColumnOrder === null || setColumnOrder === void 0 ? void 0 : setColumnOrder(function (prev) {
            var newArray = __spreadArrays(prev);
            var columnIndex = newArray.findIndex(function (id) { return id === columnName; });
            if (activate) {
    ...
    var handleOrderReset = react_1["default"].useCallback(function () {
        setColumnOrder(columns.map(function (column) { return column.accessor; }));
    }, [columns]);
    var handleRadioClick = function (columnId) {
        setColumnGroupedBy(function (prevGroupedBy) {
            var isColumnActive = prevGroupedBy.includes(columnId);
            var updatedGroupedBy = isColumnActive ? [] : [columnId];
            localStorage.setItem('columnGroupedBy', JSON.stringify(updatedGroupedBy));
            if (!isColumnActive) {
                var columnToToggle = allColumns.find(function (column) { return column.id === columnId; });
                if (columnToToggle && columnToToggle.canGroupBy) {
                    handleColumnByToggle(columnToToggle);
                }
            }
            else {
                setPagination(function (prev) { return (__assign(__assign({}, prev), { distinct: "", filters: {}, pageIndex: 0, trigger: true })); });
                handleOrderReset();
            }
    ...
    react_1.useEffect(function () {
        var storedColumnGroupedBy = localStorage.getItem('columnGroupedBy');
        if (storedColumnGroupedBy) {
            setColumnGroupedBy(JSON.parse(storedColumnGroupedBy));
        }
    }, []);
    var handleNoGroupedBy = function (column) {
        return columnGroupedBy.includes(column.accessor);
    };
    var handleRowByToggle = function (cell, column) {
        var columnName = column.id;
        var selectedRowValue = cell.row.original[columnName];
        setFilterApplied(true);
        setPagination(function (prev) {
            var _a;
            return (__assign(__assign({}, prev), { distinct: "", filters: __assign(__assign({}, prev.filters), (_a = {}, _a[columnName] = {
                    "value": selectedRowValue,
                    "operator": "equals"
                }, _a)), pageIndex: 0, trigger: true }));
        });
    };
        ...
        react_1["default"].createElement(Box_1["default"], { className: classes.containerHeader, justifyContent: "space-between", alignItems: "center" },
            react_1["default"].createElement("div", { className: clsx_1["default"]((_b = {},
                ...
                react_1["default"].createElement("div", { style: { display: 'flex', flexWrap: 'wrap', gap: 8 } },
                    ...
                    download && (react_1["default"].createElement(Button_1["default"], { className: classes.button, variant: "contained", color: "primary", disabled: loading, onClick: exportData, startIcon: react_1["default"].createElement(icons_1.DownloadIcon, null) },
                    ...
                    isShowColumnsModalOpen && (react_1["default"].createElement(components_1.DialogZyx, { open: isShowColumnsModalOpen, title: t(keys_1.langKeys.showHideColumns), buttonText2: t(keys_1.langKeys.close), handleClickButton2: function () { return setShowColumnsModalOpen(false); }, maxWidth: "sm", buttonStyle1: { marginBottom: '0.3rem' }, buttonStyle2: { marginRight: '1rem', marginBottom: '0.3rem' } },
                        react_1["default"].createElement(core_1.Grid, { container: true, spacing: 1, style: { marginTop: '0.5rem' } }, allColumns.filter(function (column) {
                            ...
                            .map(function (column) {
                            var _a;
                            return (react_1["default"].createElement(core_1.Grid, { item: true, xs: 4, key: column.id },
                                react_1["default"].createElement(core_1.FormControlLabel, { control: react_1["default"].createElement(core_1.Checkbox, { color: "primary", checked: (_a = columnVisibility[column.id]) !== null && _a !== void 0 ? _a : true, onChange: function (e) { return handleColumnVisibilityChange(column.id, e.target.checked); } }), label: t(column.Header) })));
                        })))),
                    isGroupedByModalOpen && (react_1["default"].createElement(components_1.DialogZyx, { open: isGroupedByModalOpen, title: t(keys_1.langKeys.groupedBy), buttonText2: t(keys_1.langKeys.close), handleClickButton2: function () { return setGroupedByModalOpen(false); }, maxWidth: "sm", buttonStyle1: { marginBottom: '0.3rem' }, buttonStyle2: { marginRight: '1rem', marginBottom: '0.3rem' } },
                        react_1["default"].createElement(core_1.Grid, { container: true, spacing: 1, style: { marginTop: '0.5rem' } }, columns
                            .filter(function (column) { return column.showGroupedBy === true; })
                            .map(function (column) { return (react_1["default"].createElement(core_1.Grid, { item: true, xs: 4, key: column.accessor },
                            react_1["default"].createElement(core_1.FormControlLabel, { control: react_1["default"].createElement(core_1.Radio, { color: "primary", checked: columnGroupedBy.includes(column.accessor), onClick: function () { return handleRadioClick(column.accessor); } }), label: column.Header }))); }))))))),
                ...
                react_1["default"].createElement(Table_1["default"], __assign({}, getTableProps(), { "aria-label": "enhanced table", size: "small", "aria-labelledby": "tableTitle" }),
                            ...
                            :
                                (react_1["default"].createElement(react_1["default"].Fragment, null,
                                    react_1["default"].createElement("div", { className: classes.containerHeaderColumn },
                                        column.id !== pagination.distinct && handleNoGroupedBy(__assign(__assign({}, column), { accessor: column.id, Header: column.Header })) && (react_1["default"].createElement(Tooltip_1["default"], { title: '' },
                                            react_1["default"].createElement("div", { style: { whiteSpace: 'nowrap', wordWrap: 'break-word', display: 'flex', cursor: 'pointer', alignItems: 'center' } }, column.canGroupBy === true && (react_1["default"].createElement(core_1.TableSortLabel, __assign({ active: true, direction: column.isGrouped ? 'desc' : 'asc', IconComponent: KeyboardArrowRight_1["default"], className: classes.headerIcon }, column.getHeaderProps(column.getGroupByToggleProps({
                                                title: 'Agrupar',
                                                onClick: function () { return handleColumnByToggle(column); }
                                            })))))))),
                                        react_1["default"].createElement("div", { style: { cursor: 'pointer' }, onClick: function () {
                                                setPagination(function (prev) { return (__assign(__assign({}, prev), { distinct: "", pageIndex: 0, trigger: true })); });
                                                handleOrderReset();
                                            } }, column.id === pagination.distinct && (react_1["default"].createElement(KeyboardArrowRight_2["default"], { fontSize: "small", color: "action" }))),
                    ...
                    react_1["default"].createElement(TableBody_1["default"], __assign({}, getTableBodyProps(), { style: { backgroundColor: 'white' } }), loading ?
                        ...
                        page.map(function (row) {
                            ...
                            react_1["default"].createElement(TableRow_1["default"], __assign({}, row.getRowProps(), { hover: true, style: { cursor: onClickRow ? 'pointer' : 'default' } }), row.cells.map(function (cell, index) {
                                var _a;
                                return react_1["default"].createElement(TableCell_1["default"], __assign({ key: index }, cell.getCellProps({
                                    style: {
                                ...
                                }), { onClick: function () { return cell.column.id !== "selection" ? onClickRow && onClickRow(row.original) : null; } }), (filterApplied && pagination.filters && cell.column.id in pagination.filters) ? (react_1["default"].createElement(react_1["default"].Fragment, null,
                                    react_1["default"].createElement(core_1.TableSortLabel, { className: classes.headerIcon, active: true, direction: 'asc', IconComponent: KeyboardArrowRight_1["default"], onClick: function (e) {
                                            e.stopPropagation();
                                    ...
                                    '',
                                    cell.render('Cell'))) : (react_1["default"].createElement(react_1["default"].Fragment, null, (cell.isGrouped || cell.column.id === pagination.distinct) ? (react_1["default"].createElement(react_1["default"].Fragment, null,
                                    react_1["default"].createElement(core_1.TableSortLabel, { classes: {
                                            iconDirectionAsc: classes.iconDirectionAsc,
                                            iconDirectionDesc: classes.iconDirectionDesc
                                        }, active: true, direction: row.isExpanded ? 'desc' : 'asc', IconComponent: KeyboardArrowUp_1["default"], onClick: function (e) {
                                            e.stopPropagation();
                                            if (cell.column.id !== "selection") {
                                                onClickRow && onClickRow(row.original);
                                                handleRowByToggle(cell, cell.column);
                                    ...
                                    '',
                                    cell.render('Cell'))) : ((cell.column.id !== pagination.distinct && pagination.distinct) ? null : cell.render('Cell')))));
                            })));
                        })))),
