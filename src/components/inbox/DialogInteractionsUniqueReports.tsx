...
const DialogInteractionsUniqueReports: React.FC<{ ticket: Dictionary | null, openModal: boolean, setOpenModal: (param: any) => void }> = ({ ticket, openModal, setOpenModal }) => {
...
export default DialogInteractionsUniqueReports;