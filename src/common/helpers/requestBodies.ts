...
export const insAutomatizationRules = ({ id, description, status, type, columnid, communicationchannelorigen, order, orderstatus, communicationchannelid, messagetemplateid, messagetemplateparameters, shippingtype, xdays, schedule, tags, products, operation }: Dictionary): IRequestBody => ({
