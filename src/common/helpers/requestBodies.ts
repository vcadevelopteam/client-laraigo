...
export const insCorp = ({ id, description, type, status, logo, logotype, operation, paymentplanid = 0, doctype = "", docnum = "", businessname = "", fiscaladdress = "", sunatcountry = "", contactemail = "", contact = "", autosendinvoice = false, billbyorg = false, credittype = "", paymentmethod = "", automaticpayment, automaticperiod, automaticinvoice, partner, appsettingid, citybillingid, domainname, iconurl, logourl, startlogourl, ispoweredbylaraigo, olddomainname, billingcurrency }: Dictionary): IRequestBody => ({
    method: "UFN_CORP_INS",
    key: "UFN_CORP_INS",
