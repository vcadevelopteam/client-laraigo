export const icons = {
    ...
    REPORTS: './icons/chart-bar-bargraph.svg',
    TICKETS: './icons/ticket.svg',
    EMAIL_INBOX: './icons/email-mail-letter.svg',
    MESSAGE_INBOX: './icons/chat-message-password-input.svg',
