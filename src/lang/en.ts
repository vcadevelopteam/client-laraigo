...
const translation: LangKeys = {
    ...
    channelcharge: "Total cost of channels",
    ...
    userAverageReplyTimexFecha: "Heat Map Average agent response time",
    ...
    efectividadxAsesor: "Rate of effectiveness per agent",
    ...
    heatmapaverageagentTME: "Heat Map Average agent response time",
    ...
    ticket_tiempopromediorespuesta: 'TMR',
    ticket_tiempopromediorespuestaasesor: 'TMR agent',
    ticket_tiempoprimerarespuestaasesor: 'TME Agent',
