...
const translation: LangKeys = {
    ...
    issuerruc: "RucEmisor",
    issuerbusinessname: "RazonSocialEmisor",
    issuertradename: "NombreComercialEmisor",
    issuerfiscaladdress: "DireccionFiscalEmisor",
    issuerubigeo: "CodigoUbigeoEmisor",
    emittertype: "TipoEmisor",
    annexcode: "CodigoAnexoEmisor",
    printingformat: "CodigoFormatoImpresion",
    returnpdf: "RetornaPdf",
    sendtosunat: "EnviarSunat",
    returnxmlsunat: "ReturnxmlSunat",
    returnxml: "RetornaXml",
    sunaturl: "SunatUrl",
    sunatusername: "UsuarioSunat",
    xmlversion: "VersionXml",
    ublversion: "VersionUbl",
    receiverdoctype: "CodigoRucReceptor",
    receiverdocnum: "NumeroDocumentoReceptor",
    receiverbusinessname: "RazonSocialReceptor",
    receiverfiscaladdress: "DireccionFiscalReceptor",
    receivercountry: "TXT_PAIS_RECEP",
    receivermail: "MailEnvio",
    invoicetype: "TipoFactura",
    sunatopecode: "CodigoOperacionSunat",
    serie: "NumeroSerieDocumento",
    correlative: "CorrelativoDocumento",
    concept: "Concepto",
    invoicedate: "FechaEmision",
    expirationdate: "Fecha Expiración",
    subtotal: "MontoTotalGravado",
    taxes: "MontoTotalIgv",
    ...
    urlxml: "urlXml",
    filenumber: "NúmeroExpediente",
    purchaseorder: "OrdenCompra",
    executingunitcode: "EjecutandoUnitCode",
    selectionprocessnumber: "SelectionProcessNumber",
    contractnumber: "NúmeroContrato",
    orderid: "SolicitarID",
    orderjson: "OrderJson",
