export const langKeys = {
  ...
  report_kpioperativo_userpause_hour_avg:
    "report_kpioperativo_userpause_hour_avg",
  report_kpioperativo_tmoasesor_tickets:
    "report_kpioperativo_tmoasesor_tickets",
  report_kpioperativo_tickets_eqtmoasesor:
    "report_kpioperativo_tickets_eqtmoasesor",
  report_kpioperativo_tmoasesor_hour_sum:
    "report_kpioperativo_tmoasesor_hour_sum",
  ...
  ticket_communicationchanneldescription:
    "ticket_communicationchanneldescription",
  ...
  dashboard_managerial_tmo_targettmo_min:
    "dashboard_managerial_tmo_targettmo_min",
  dashboard_managerial_tmo_targettmo_max:
    "dashboard_managerial_tmo_targettmo_max",
  ...
  dashboard_managerial_tmo_targettmoasesor_min:
    "dashboard_managerial_tmo_targettmoasesor_min",
  dashboard_managerial_tmo_targettmoasesor_max:
    "dashboard_managerial_tmo_targettmoasesor_max",
  dashboard_managerial_tmo_targettmoasesor:
    "dashboard_managerial_tmo_targettmoasesor",
  ...
  dashboard_managerial_tme_targettme_max:
    "dashboard_managerial_tme_targettme_max",
  ...
  dashboard_managerial_survey3_ticketnum:
    "dashboard_managerial_survey3_ticketnum",
  dashboard_managerial_survey3_closedby:
    "dashboard_managerial_survey3_closedby",
  dashboard_managerial_survey3_surveytype:
    "dashboard_managerial_survey3_surveytype",
  dashboard_managerial_survey3_answervalue:
    "dashboard_managerial_survey3_answervalue",
  ...
  dashboard_managerial_survey2_ticketnum:
    "dashboard_managerial_survey2_ticketnum",
  dashboard_managerial_survey2_closedby:
    "dashboard_managerial_survey2_closedby",
  dashboard_managerial_survey2_surveytype:
    "dashboard_managerial_survey2_surveytype",
  dashboard_managerial_survey2_answervalue:
    "dashboard_managerial_survey2_answervalue",
  ...
  dashboard_managerial_summary_ticketnum:
    "dashboard_managerial_summary_ticketnum",
  dashboard_managerial_summary_closedby:
    "dashboard_managerial_summary_closedby",
  dashboard_managerial_summary_channel: "dashboard_managerial_summary_channel",
  dashboard_managerial_summary_hourrange:
    "dashboard_managerial_summary_hourrange",
  ...
  dashboard_managerial_asesoresconectados_date:
    "dashboard_managerial_asesoresconectados_date",
  dashboard_managerial_asesoresconectados_hour:
    "dashboard_managerial_asesoresconectados_hour",
  dashboard_managerial_asesoresconectados_agent:
    "dashboard_managerial_asesoresconectados_agent",

  dashboard_managerial_averageconversations_ticketnum:
    "dashboard_managerial_averageconversations_ticketnum",
  dashboard_managerial_averageconversations_startdate:
    "dashboard_managerial_averageconversations_startdate",
  dashboard_managerial_averageconversations_finishdate:
    "dashboard_managerial_averageconversations_finishdate",
  dashboard_managerial_averageconversations_channel:
    "dashboard_managerial_averageconversations_channel",
  dashboard_managerial_averageconversations_status:
    "dashboard_managerial_averageconversations_status",
  dashboard_managerial_averageconversations_closedby:
    "dashboard_managerial_averageconversations_closedby",

  dashboard_managerial_interaction_ticketnum:
    "dashboard_managerial_interaction_ticketnum",
  dashboard_managerial_interaction_startdate:
    "dashboard_managerial_interaction_startdate",
  dashboard_managerial_interaction_interactioncode:
    "dashboard_managerial_interaction_interactioncode",
  dashboard_managerial_interaction_interactionhour:
    "dashboard_managerial_interaction_interactionhour",
  dashboard_managerial_interaction_agent:
    "dashboard_managerial_interaction_agent",
  dashboard_managerial_interaction_interactiontype:
    "dashboard_managerial_interaction_interactiontype",
  dashboard_managerial_interaction_interactiontext:
    "dashboard_managerial_interaction_interactiontext",
  dashboard_managerial_interaction_clientnumber:
    "dashboard_managerial_interaction_clientnumber",
  dashboard_managerial_interaction_channel:
    "dashboard_managerial_interaction_channel",

  dashboard_managerial_etiqueta_ticketnum:
    "dashboard_managerial_etiqueta_ticketnum",
  dashboard_managerial_etiqueta_closedby:
    "dashboard_managerial_etiqueta_closedby",
  dashboard_managerial_etiqueta_agent: "dashboard_managerial_etiqueta_agent",
  dashboard_managerial_etiqueta_channel:
    "dashboard_managerial_etiqueta_channel",
  ...
  dashboard_productivity_tmo_targettmo_min:
    "dashboard_productivity_tmo_targettmo_min",
  dashboard_productivity_tmo_targettmo_max:
    "dashboard_productivity_tmo_targettmo_max",
  ...
  dashboard_productivity_tmo_targettmoasesor_min:
    "dashboard_productivity_tmo_targettmoasesor_min",
  dashboard_productivity_tmo_targettmoasesor_max:
    "dashboard_productivity_tmo_targettmoasesor_max",
  dashboard_productivity_tmo_targettmoasesor:
    "dashboard_productivity_tmo_targettmoasesor",
  ...
  dashboard_productivity_tme_targettme_max:
    "dashboard_productivity_tme_targettme_max",
  ...
  dashboard_productivity_tmodistribution_ticketnum:
    "dashboard_productivity_tmodistribution_ticketnum",
  dashboard_productivity_tmodistribution_hourrange:
    "dashboard_productivity_tmodistribution_hourrange",
  dashboard_productivity_tmodistribution_closedby:
    "dashboard_productivity_tmodistribution_closedby",
  dashboard_productivity_tmodistribution_channel:
    "dashboard_productivity_tmodistribution_channel",
  dashboard_productivity_tmodistribution_agent:
    "dashboard_productivity_tmodistribution_agent",
  dashboard_productivity_tmodistribution_duration:
    "dashboard_productivity_tmodistribution_duration",

  dashboard_productivity_tmedistribution_ticketnum:
    "dashboard_productivity_tmedistribution_ticketnum",
  dashboard_productivity_tmedistribution_hourrange:
    "dashboard_productivity_tmedistribution_hourrange",
  dashboard_productivity_tmedistribution_closedby:
    "dashboard_productivity_tmedistribution_closedby",
  dashboard_productivity_tmedistribution_channel:
    "dashboard_productivity_tmedistribution_channel",
  dashboard_productivity_tmedistribution_agent:
    "dashboard_productivity_tmedistribution_agent",
  dashboard_productivity_tmedistribution_duration:
    "dashboard_productivity_tmedistribution_duration",

  dashboard_productivity_prodxhoradist_ticketnum:
    "dashboard_productivity_prodxhoradist_ticketnum",
  dashboard_productivity_prodxhoradist_hourrange:
    "dashboard_productivity_prodxhoradist_hourrange",
  dashboard_productivity_prodxhoradist_closedby:
    "dashboard_productivity_prodxhoradist_closedby",
  dashboard_productivity_prodxhoradist_channel:
    "dashboard_productivity_prodxhoradist_channel",
  dashboard_productivity_prodxhoradist_agent:
    "dashboard_productivity_prodxhoradist_agent",

  dashboard_productivity_survey3_ticketnum:
    "dashboard_productivity_survey3_ticketnum",
  dashboard_productivity_survey3_closedby:
    "dashboard_productivity_survey3_closedby",
  dashboard_productivity_survey3_surveytype:
    "dashboard_productivity_survey3_surveytype",
  dashboard_productivity_survey3_answervalue:
    "dashboard_productivity_survey3_answervalue",
  dashboard_productivity_survey3_answer:
    "dashboard_productivity_survey3_answer",
  dashboard_productivity_survey3_comment:
    "dashboard_productivity_survey3_comment",

  dashboard_productivity_survey2_ticketnum:
    "dashboard_productivity_survey2_ticketnum",
  dashboard_productivity_survey2_closedby:
    "dashboard_productivity_survey2_closedby",
  dashboard_productivity_survey2_surveytype:
    "dashboard_productivity_survey2_surveytype",
  dashboard_productivity_survey2_answervalue:
    "dashboard_productivity_survey2_answervalue",
  dashboard_productivity_survey2_answer:
    "dashboard_productivity_survey2_answer",
  dashboard_productivity_survey2_comment:
    "dashboard_productivity_survey2_comment",

  dashboard_operationalpush_summary_ticketnum:
    "dashboard_operationalpush_summary_ticketnum",
  dashboard_operationalpush_summary_clientnumber:
    "dashboard_operationalpush_summary_clientnumber",
  dashboard_operationalpush_summary_hsm:
    "dashboard_operationalpush_summary_hsm",
  dashboard_operationalpush_summary_campaign:
    "dashboard_operationalpush_summary_campaign",
  dashboard_operationalpush_summary_datehour:
    "dashboard_operationalpush_summary_datehour",
  dashboard_operationalpush_summary_status:
    "dashboard_operationalpush_summary_status",
  dashboard_operationalpush_summary_answerdate:
    "dashboard_operationalpush_summary_answerdate",

  dashboard_operationalpush_categoryrank_hsmcategory:
    "dashboard_operationalpush_categoryrank_hsmcategory",
  dashboard_operationalpush_categoryrank_hsm:
    "dashboard_operationalpush_categoryrank_hsm",

  dashboard_operationalpush_hsmrank_hsm:
    "dashboard_operationalpush_hsmrank_hsm",
  dashboard_operationalpush_hsmrank_sentdate:
    "dashboard_operationalpush_hsmrank_sentdate",
  dashboard_operationalpush_hsmrank_senthour:
    "dashboard_operationalpush_hsmrank_senthour",

  dashboard_operationalpush_messageperday_hsm:
    "dashboard_operationalpush_messageperday_hsm",
  dashboard_operationalpush_messageperday_campaign:
    "dashboard_operationalpush_messageperday_campaign",
  dashboard_operationalpush_messageperday_sentdate:
    "dashboard_operationalpush_messageperday_sentdate",
  dashboard_operationalpush_messageperday_clientnumber:
    "dashboard_operationalpush_messageperday_clientnumber",
  dashboard_operationalpush_messageperday_status:
    "dashboard_operationalpush_messageperday_status",

  dashboard_operationalpush_application_application:
    "dashboard_operationalpush_application_application",
  dashboard_operationalpush_application_hsm:
    "dashboard_operationalpush_application_hsm",
  dashboard_operationalpush_application_sentdate:
    "dashboard_operationalpush_application_sentdate",
  dashboard_operationalpush_application_clientnumber:
    "dashboard_operationalpush_application_clientnumber",
  dashboard_operationalpush_application_status:
    "dashboard_operationalpush_application_status",
  dashboard_operationalpush_application_tag:
    "dashboard_operationalpush_application_tag",
  dashboard_operationalpush_application_quantity:
    "dashboard_operationalpush_application_quantity",
  dashboard_operationalpush_application_channel:
    "dashboard_operationalpush_application_channel",

  dashboard_operationalpush_disconnections_usr:
    "dashboard_operationalpush_disconnections_usr",
  dashboard_operationalpush_disconnections_type:
    "dashboard_operationalpush_disconnections_type",
  dashboard_operationalpush_disconnections_time:
    "dashboard_operationalpush_disconnections_time",
  dashboard_operationalpush_disconnections_fullname:
    "dashboard_operationalpush_disconnections_fullname",
  dashboard_operationalpush_disconnections_usergroups:
    "dashboard_operationalpush_disconnections_usergroups",
  dashboard_operationalpush_disconnections_userstatus:
    "dashboard_operationalpush_disconnections_userstatus",
  dashboard_operationalpush_disconnections_conectedtime:
    "dashboard_operationalpush_disconnections_conectedtime",
  ...
  report_productivity_derivationtime_help:
    "report_productivity_derivationtime_help",
  report_productivity_firstinteractiondate:
    "report_productivity_firstinteractiondate",
  report_productivity_firstinteractiontime:
    "report_productivity_firstinteractiontime",
  ...
  report_tipification_classificationlevel1:
    "report_tipification_classificationlevel1",
  report_tipification_classificationlevel2:
    "report_tipification_classificationlevel2",
  report_tipification_classificationlevel3:
    "report_tipification_classificationlevel3",
  report_tipification_enddate: "report_tipification_enddate",
  report_tipification_endtime: "report_tipification_endtime",
  report_tipification_firstinteractiondate:
    "report_tipification_firstinteractiondate",
  report_tipification_firstinteractiontime:
    "report_tipification_firstinteractiontime",
  ...
  report_userproductivityhours_hoursrange:
    "report_userproductivityhours_hoursrange",
  report_userproductivityhours_worktime:
    "report_userproductivityhours_worktime",
  ...
  report_userproductivityhours_busytimeoutsidework:
    "report_userproductivityhours_busytimeoutsidework",
  report_userproductivityhours_onlinetime:
    "report_userproductivityhours_onlinetime",
  report_userproductivityhours_idletime:
    "report_userproductivityhours_idletime",
  report_userproductivityhours_qtytickets:
    "report_userproductivityhours_qtytickets",
  ...
  report_userproductivityhours_filter_adviser:
    "report_userproductivityhours_filter_adviser",
  report_userproductivityhours_filter_channels:
    "report_userproductivityhours_filter_channels",
  report_userproductivityhours_filter_hours:
    "report_userproductivityhours_filter_hours",

  report_userproductivity: "report_userproductivity",
  report_userproductivity_totalclosedtickets:
    "report_userproductivity_totalclosedtickets",
  report_userproductivity_holdingtickets:
    "report_userproductivity_holdingtickets",
  report_userproductivity_asesortickets:
    "report_userproductivity_asesortickets",
  report_userproductivity_usersconnected:
    "report_userproductivity_usersconnected",
  ...
  report_userproductivity_hourfirstlogin:
    "report_userproductivity_hourfirstlogin",
  report_userproductivity_totaltickets: "report_userproductivity_totaltickets",
  report_userproductivity_closedtickets:
    "report_userproductivity_closedtickets",
  report_userproductivity_asignedtickets:
    "report_userproductivity_asignedtickets",
  report_userproductivity_suspendedtickets:
    "report_userproductivity_suspendedtickets",
  report_userproductivity_avgfirstreplytime:
    "report_userproductivity_avgfirstreplytime",
  report_userproductivity_maxfirstreplytime:
    "report_userproductivity_maxfirstreplytime",
  report_userproductivity_minfirstreplytime:
    "report_userproductivity_minfirstreplytime",
  report_userproductivity_avgtotalduration:
    "report_userproductivity_avgtotalduration",
  report_userproductivity_maxtotalduration:
    "report_userproductivity_maxtotalduration",
  report_userproductivity_mintotalduration:
    "report_userproductivity_mintotalduration",
  report_userproductivity_avgtotalasesorduration:
    "report_userproductivity_avgtotalasesorduration",
  report_userproductivity_maxtotalasesorduration:
    "report_userproductivity_maxtotalasesorduration",
  report_userproductivity_mintotalasesorduration:
    "report_userproductivity_mintotalasesorduration",
  report_userproductivity_userconnectedduration:
    "report_userproductivity_userconnectedduration",
  ...
  report_userproductivity_cardtmoadviser:
    "report_userproductivity_cardtmoadviser",
  ...
  report_userproductivity_cardavgmax_tme:
    "report_userproductivity_cardavgmax_tme",
  report_userproductivity_cardmaxmax_tme:
    "report_userproductivity_cardmaxmax_tme",
  report_userproductivity_cardavgmin_tme:
    "report_userproductivity_cardavgmin_tme",
  report_userproductivity_cardminmin_tme:
    "report_userproductivity_cardminmin_tme",

  report_userproductivity_cardavgmax_tmo:
    "report_userproductivity_cardavgmax_tmo",
  report_userproductivity_cardmaxmax_tmo:
    "report_userproductivity_cardmaxmax_tmo",
  report_userproductivity_cardavgmin_tmo:
    "report_userproductivity_cardavgmin_tmo",
  report_userproductivity_cardminmin_tmo:
    "report_userproductivity_cardminmin_tmo",

  report_userproductivity_cardavgmax_tmoagent:
    "report_userproductivity_cardavgmax_tmoagent",
  report_userproductivity_cardmaxmax_tmoagent:
    "report_userproductivity_cardmaxmax_tmoagent",
  report_userproductivity_cardavgmin_tmoagent:
    "report_userproductivity_cardavgmin_tmoagent",
  report_userproductivity_cardminmin_tmoagent:
    "report_userproductivity_cardminmin_tmoagent",
  ...
  report_userproductivity_minticketsclosedasesorhelptext:
    "report_userproductivity_minticketsclosedasesorhelptext",
  report_userproductivity_maxtimeconnectedasesorhelptext:
    "report_userproductivity_maxtimeconnectedasesorhelptext",
  report_userproductivity_mintimeconnectedasesorhelptext:
    "report_userproductivity_mintimeconnectedasesorhelptext",

  report_userproductivity_filter_channels:
    "report_userproductivity_filter_channels",
  report_userproductivity_filter_group: "report_userproductivity_filter_group",
  report_userproductivity_filter_status:
    "report_userproductivity_filter_status",
  report_userproductivity_filter_includebot:
    "report_userproductivity_filter_includebot",
  ...
  "personalizedreport_conversation.firstassignedtime":
    "personalizedreport_conversation.firstassignedtime",
  "personalizedreport_conversation.corpid":
    "personalizedreport_conversation.corpid",
  "personalizedreport_conversation.orgid":
    "personalizedreport_conversation.orgid",
  "personalizedreport_conversation.personid":
    "personalizedreport_conversation.personid",
  "personalizedreport_conversation.personcommunicationchannel":
    "personalizedreport_conversation.personcommunicationchannel",
  "personalizedreport_conversation.conversationid":
    "personalizedreport_conversation.conversationid",
  "personalizedreport_conversation.communicationchannelid":
    "personalizedreport_conversation.communicationchannelid",
  "personalizedreport_conversation.description":
    "personalizedreport_conversation.description",
  "personalizedreport_conversation.status":
    "personalizedreport_conversation.status",
  "personalizedreport_conversation.type":
    "personalizedreport_conversation.type",
  "personalizedreport_conversation.createdate":
    "personalizedreport_conversation.createdate",
  "personalizedreport_conversation.createby":
    "personalizedreport_conversation.createby",
  "personalizedreport_conversation.changedate":
    "personalizedreport_conversation.changedate",
  "personalizedreport_conversation.changeby":
    "personalizedreport_conversation.changeby",
  ...
  "personalizedreport_conversation.startdate":
    "personalizedreport_conversation.startdate",
  "personalizedreport_conversation.finishdate":
    "personalizedreport_conversation.finishdate",
  ...
  "personalizedreport_conversation.closetype":
    "personalizedreport_conversation.closetype",
  "personalizedreport_conversation.context":
    "personalizedreport_conversation.context",
  ...
  "personalizedreport_conversation.wnlukeywords":
    "personalizedreport_conversation.wnlukeywords",
  "personalizedreport_conversation.wnlumetadata":
    "personalizedreport_conversation.wnlumetadata",
  ...
  "personalizedreport_conversation.wtaanger":
    "personalizedreport_conversation.wtaanger",
  "personalizedreport_conversation.wtafear":
    "personalizedreport_conversation.wtafear",
  ...
  "personalizedreport_conversation.wtaimpolite":
    "personalizedreport_conversation.wtaimpolite",
  "personalizedreport_conversation.wtapolite":
    "personalizedreport_conversation.wtapolite",
  "personalizedreport_conversation.wtasad":
    "personalizedreport_conversation.wtasad",
  ...
  "personalizedreport_conversation.wtapersonsympathetic":
    "personalizedreport_conversation.wtapersonsympathetic",
  "personalizedreport_conversation.wnlusyntax":
    "personalizedreport_conversation.wnlusyntax",
  "personalizedreport_conversation.wnlusentiment":
    "personalizedreport_conversation.wnlusentiment",
  "personalizedreport_conversation.wnlusadness":
    "personalizedreport_conversation.wnlusadness",
  "personalizedreport_conversation.wnlujoy":
    "personalizedreport_conversation.wnlujoy",
  "personalizedreport_conversation.wnlufear":
    "personalizedreport_conversation.wnlufear",
  "personalizedreport_conversation.wnludisgust":
    "personalizedreport_conversation.wnludisgust",
  "personalizedreport_conversation.wnluanger":
    "personalizedreport_conversation.wnluanger",
  ...
  "personalizedreport_conversation.wnlupersonanger":
    "personalizedreport_conversation.wnlupersonanger",
  "personalizedreport_conversation.enquiries":
    "personalizedreport_conversation.enquiries",
  ...
  "personalizedreport_conversation.emailalertsent":
    "personalizedreport_conversation.emailalertsent",
  "personalizedreport_conversation.tdatime":
    "personalizedreport_conversation.tdatime",
  ...
  "personalizedreport_conversation.closecomment":
    "personalizedreport_conversation.closecomment",
  "personalizedreport_conversation.origin":
    "personalizedreport_conversation.origin",
  "personalizedreport_conversation.campaignid":
    "personalizedreport_conversation.campaignid",
  ...
  "personalizedreport_corp.paymentplanid":
    "personalizedreport_corp.paymentplanid",
  ...
  "personalizedreport_corp.businessname":
    "personalizedreport_corp.businessname",
  "personalizedreport_corp.fiscaladdress":
    "personalizedreport_corp.fiscaladdress",
  "personalizedreport_corp.sunatcountry":
    "personalizedreport_corp.sunatcountry",
  "personalizedreport_corp.contactemail":
    "personalizedreport_corp.contactemail",
  ...
  "personalizedreport_corp.canceleddate":
    "personalizedreport_corp.canceleddate",
  ...
  "personalizedreport_corp.paymentmethod":
    "personalizedreport_corp.paymentmethod",
  ...
  "personalizedreport_org.fiscaladdress":
    "personalizedreport_org.fiscaladdress",
  ...
  "personalizedreport_person.description":
    "personalizedreport_person.description",
  ...
  "personalizedreport_person.createdate":
    "personalizedreport_person.createdate",
  "personalizedreport_person.createby": "personalizedreport_person.createby",
  "personalizedreport_person.changedate":
    "personalizedreport_person.changedate",
  ...
  "personalizedreport_person.referringperson":
    "personalizedreport_person.referringperson",
  "personalizedreport_person.referringpersonid":
    "personalizedreport_person.referringpersonid",
  "personalizedreport_person.persontype":
    "personalizedreport_person.persontype",
  "personalizedreport_person.personstatus":
    "personalizedreport_person.personstatus",
  ...
  "personalizedreport_person.lastcommunicationchannelid":
    "personalizedreport_person.lastcommunicationchannelid",
  "personalizedreport_person.documenttype":
    "personalizedreport_person.documenttype",
  ...
  "personalizedreport_person.imageurldef":
    "personalizedreport_person.imageurldef",
  ...
  "personalizedreport_person.addressreference":
    "personalizedreport_person.addressreference",
  "personalizedreport_person.clientnumber":
    "personalizedreport_person.clientnumber",
  ...
  "personalizedreport_person.geographicalarea":
    "personalizedreport_person.geographicalarea",
  "personalizedreport_person.age": "personalizedreport_person.age",
  "personalizedreport_person.observation":
    "personalizedreport_person.observation",
  ...
  "personalizedreport_communicationchannel.status":
    "personalizedreport_communicationchannel.status",
  "personalizedreport_communicationchannel.type":
    "personalizedreport_communicationchannel.type",
  ...
  "personalizedreport_communicationchannel.resolvelithium":
    "personalizedreport_communicationchannel.resolvelithium",
  "personalizedreport_communicationchannel.color":
    "personalizedreport_communicationchannel.color",
  "personalizedreport_communicationchannel.icons":
    "personalizedreport_communicationchannel.icons",
  "personalizedreport_communicationchannel.other":
    "personalizedreport_communicationchannel.other",
  "personalizedreport_communicationchannel.form":
    "personalizedreport_communicationchannel.form",
  "personalizedreport_communicationchannel.apikey":
    "personalizedreport_communicationchannel.apikey",
  "personalizedreport_communicationchannel.servicecredentials":
    "personalizedreport_communicationchannel.servicecredentials",
  "personalizedreport_communicationchannel.phone":
    "personalizedreport_communicationchannel.phone",
  ...
  "personalizedreport_firstuser.description":
    "personalizedreport_firstuser.description",
  "personalizedreport_firstuser.firstname":
    "personalizedreport_firstuser.firstname",
  "personalizedreport_firstuser.lastname":
    "personalizedreport_firstuser.lastname",
  ...
  "personalizedreport_firstuser.createdate":
    "personalizedreport_firstuser.createdate",
  "personalizedreport_firstuser.createby":
    "personalizedreport_firstuser.createby",
  "personalizedreport_firstuser.changedate":
    "personalizedreport_firstuser.changedate",
  "personalizedreport_firstuser.changeby":
    "personalizedreport_firstuser.changeby",
  "personalizedreport_firstuser.pwdchangefirstlogin":
    "personalizedreport_firstuser.pwdchangefirstlogin",
  "personalizedreport_firstuser.company":
    "personalizedreport_firstuser.company",
  ...
  "personalizedreport_firstuser.location":
    "personalizedreport_firstuser.location",
  ...
  "personalizedreport_lastuser.description":
    "personalizedreport_lastuser.description",
  "personalizedreport_lastuser.firstname":
    "personalizedreport_lastuser.firstname",
  "personalizedreport_lastuser.lastname":
    "personalizedreport_lastuser.lastname",
  ...
  "personalizedreport_lastuser.createdate":
    "personalizedreport_lastuser.createdate",
  "personalizedreport_lastuser.createby":
    "personalizedreport_lastuser.createby",
  "personalizedreport_lastuser.changedate":
    "personalizedreport_lastuser.changedate",
  "personalizedreport_lastuser.changeby":
    "personalizedreport_lastuser.changeby",
  ...
  "personalizedreport_lastuser.registercode":
    "personalizedreport_lastuser.registercode",
  "personalizedreport_lastuser.usercall":
    "personalizedreport_lastuser.usercall",
  ...
  "personalizedreport_lastuser.location":
    "personalizedreport_lastuser.location",
  "personalizedreport_lastuser.management":
    "personalizedreport_lastuser.management",
  ...
  "personalizedreport_lastuser.customerservice":
    "personalizedreport_lastuser.customerservice",
  "personalizedreport_lastuser.marketing":
    "personalizedreport_lastuser.marketing",
  "personalizedreport_lastuser.rolecompany":
    "personalizedreport_lastuser.rolecompany",
  "personalizedreport_lastuser.redirect":
    "personalizedreport_lastuser.redirect",
  ...
  "personalizedreport_campaign.description":
    "personalizedreport_campaign.description",
  "personalizedreport_campaign.startdate":
    "personalizedreport_campaign.startdate",
  ...
  "personalizedreport_campaign.repeatable":
    "personalizedreport_campaign.repeatable",
  "personalizedreport_campaign.frecuency":
    "personalizedreport_campaign.frecuency",
  "personalizedreport_campaign.createdate":
    "personalizedreport_campaign.createdate",
  "personalizedreport_campaign.createby":
    "personalizedreport_campaign.createby",
  "personalizedreport_campaign.changedate":
    "personalizedreport_campaign.changedate",
  "personalizedreport_campaign.changeby":
    "personalizedreport_campaign.changeby",
  ...
  "personalizedreport_outboundhistory.shippingdate":
    "personalizedreport_outboundhistory.shippingdate",
  "personalizedreport_outboundhistory.corpid":
    "personalizedreport_outboundhistory.corpid",
  "personalizedreport_outboundhistory.orgid":
    "personalizedreport_outboundhistory.orgid",
  "personalizedreport_outboundhistory.id":
    "personalizedreport_outboundhistory.id",
  "personalizedreport_outboundhistory.description":
    "personalizedreport_outboundhistory.description",
  "personalizedreport_outboundhistory.status":
    "personalizedreport_outboundhistory.status",
  "personalizedreport_outboundhistory.type":
    "personalizedreport_outboundhistory.type",
  ...
  "personalizedreport_outboundhistory.success":
    "personalizedreport_outboundhistory.success",
  "personalizedreport_outboundhistory.origin":
    "personalizedreport_outboundhistory.origin",
  "personalizedreport_outboundhistory.communicationchannelid":
    "personalizedreport_outboundhistory.communicationchannelid",
  "personalizedreport_outboundhistory.title":
    "personalizedreport_outboundhistory.title",
  ...
  "personalizedreport_outboundhistory.clientname":
    "personalizedreport_outboundhistory.clientname",
  "personalizedreport_outboundhistory.body":
    "personalizedreport_outboundhistory.body",
  "personalizedreport_outboundhistory.usergroup":
    "personalizedreport_outboundhistory.usergroup",
  "personalizedreport_outboundhistory.log":
    "personalizedreport_outboundhistory.log",
  "personalizedreport_outboundhistory.conversationid":
    "personalizedreport_outboundhistory.conversationid",
  "personalizedreport_messagetemplate.description":
    "personalizedreport_messagetemplate.description",
  "personalizedreport_messagetemplate.type":
    "personalizedreport_messagetemplate.type",
  "personalizedreport_messagetemplate.status":
    "personalizedreport_messagetemplate.status",
  "personalizedreport_messagetemplate.createdate":
    "personalizedreport_messagetemplate.createdate",
  "personalizedreport_messagetemplate.createby":
    "personalizedreport_messagetemplate.createby",
  "personalizedreport_messagetemplate.changedate":
    "personalizedreport_messagetemplate.changedate",
  "personalizedreport_messagetemplate.changeby":
    "personalizedreport_messagetemplate.changeby",
  "personalizedreport_messagetemplate.name":
    "personalizedreport_messagetemplate.name",
  "personalizedreport_messagetemplate.namespace":
    "personalizedreport_messagetemplate.namespace",
  "personalizedreport_messagetemplate.category":
    "personalizedreport_messagetemplate.category",
  "personalizedreport_messagetemplate.language":
    "personalizedreport_messagetemplate.language",
  ...
  "personalizedreport_messagetemplate.headertype":
    "personalizedreport_messagetemplate.headertype",
  "personalizedreport_messagetemplate.header":
    "personalizedreport_messagetemplate.header",
  "personalizedreport_messagetemplate.body":
    "personalizedreport_messagetemplate.body",
  "personalizedreport_messagetemplate.footerenabled":
    "personalizedreport_messagetemplate.footerenabled",
  "personalizedreport_messagetemplate.footer":
    "personalizedreport_messagetemplate.footer",
  "personalizedreport_messagetemplate.buttonsenabled":
    "personalizedreport_messagetemplate.buttonsenabled",
  "personalizedreport_messagetemplate.buttons":
    "personalizedreport_messagetemplate.buttons",
  "personalizedreport_messagetemplate.priority":
    "personalizedreport_messagetemplate.priority",
  "personalizedreport_messagetemplate.attachment":
    "personalizedreport_messagetemplate.attachment",

  "personalizedreport_surveyansweredsummary.csat_question":
    "personalizedreport_surveyansweredsummary.csat_question",
  "personalizedreport_surveyansweredsummary.csat_answervalue":
    "personalizedreport_surveyansweredsummary.csat_answervalue",
  "personalizedreport_surveyansweredsummary.csat_answer":
    "personalizedreport_surveyansweredsummary.csat_answer",
  "personalizedreport_surveyansweredsummary.nps_question":
    "personalizedreport_surveyansweredsummary.nps_question",
  "personalizedreport_surveyansweredsummary.nps_answervalue":
    "personalizedreport_surveyansweredsummary.nps_answervalue",
  "personalizedreport_surveyansweredsummary.nps_answer":
    "personalizedreport_surveyansweredsummary.nps_answer",
  "personalizedreport_surveyansweredsummary.fix_question":
    "personalizedreport_surveyansweredsummary.fix_question",
  "personalizedreport_surveyansweredsummary.fix_answervalue":
    "personalizedreport_surveyansweredsummary.fix_answervalue",
  "personalizedreport_surveyansweredsummary.fix_answer":
    "personalizedreport_surveyansweredsummary.fix_answer",

  "personalizedreport_firstorguser.groups":
    "personalizedreport_firstorguser.groups",
  "personalizedreport_firstorguser.channels":
    "personalizedreport_firstorguser.channels",
  "personalizedreport_firstorguser.type":
    "personalizedreport_firstorguser.type",
  "personalizedreport_lastorguser.groups":
    "personalizedreport_lastorguser.groups",
  "personalizedreport_lastorguser.channels":
    "personalizedreport_lastorguser.channels",
  ...
  "type_activitylead_email: welcome demo":
    "type_activitylead_email: welcome demo",
  ...
  propertyalertaprimerainteraciondashboard:
    "propertyalertaprimerainteraciondashboard",
  propertyconversacionesatendidasporcentaje:
    "propertyconversacionesatendidasporcentaje",
  ...
  "filter_firstuser.pwdchangefirstlogin":
    "filter_conversation.pwdchangefirstlogin",
  "filter_conversation.wnluuserjoy": "filter_conversation.wnluuserjoy",
  "filter_conversation.wtauserconfident":
    "filter_conversation.wtauserconfident",
  ...
  type_close_cierre_por_envio_de_campaña:
    "type_close_cierre_por_envio_de_campaña",
  ...
  voximplant_organizationenabledrecharge:
    "voximplant_organizationenabledrecharge",
  voximplant_organizationchanneladditional:
    "voximplant_organizationchanneladditional",
  voximplant_organizationchannelrecharge:
    "voximplant_organizationchannelrecharge",
  voximplant_organizationcostmaximum: "voximplant_organizationcostmaximum",
  voximplant_organizationchannelpercentage:
    "voximplant_organizationchannelpercentage",
  ...
  voximplant_organizationmanualrecharge:
    "voximplant_organizationmanualrecharge",
  ...
  invoiceat: "invoiceat",
  voximplant_organizationupdatescenario:
    "voximplant_organizationupdatescenario",
  ...
  billingsetup_artificialintelligencedetail:
    "billingsetup_artificialintelligencedetail",
  billingsetup_artificialintelligencenew:
    "billingsetup_artificialintelligencenew",
  ...
  postcreator_publish_textrecommendation:
    "postcreator_publish_textrecommendation",
  postcreator_publish_textrecommendation01:
    "postcreator_publish_textrecommendation01",
  ...
  postcreator_publish_facebookmockup_time:
    "postcreator_publish_facebookmockup_time",
  postcreator_publish_facebookmockup_like:
    "postcreator_publish_facebookmockup_like",
  postcreator_publish_facebookmockup_comment:
    "postcreator_publish_facebookmockup_comment",
  postcreator_publish_facebookmockup_share:
    "postcreator_publish_facebookmockup_share",
  postcreator_publish_tiktokmockup_follow:
    "postcreator_publish_tiktokmockup_follow",
  postcreator_publish_linkedin_follower:
    "postcreator_publish_linkedin_follower",
  ...
  postcreator_publish_youtube_subscribe:
    "postcreator_publish_youtube_subscribe",
  postcreator_publish_youtube_subscribers:
    "postcreator_publish_youtube_subscribers",
