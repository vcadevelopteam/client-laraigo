...
const DashboardOperationalPush: FC = () => {
    ...
    async function downloaddata(tipeoffilter:string){
        ...
        if (tipeoffilter === "SUMMARY") {
            ...
            dispatch(getCollectionAux(getdashboardPushAppSel(tosend)))
        }
    }
    return (
        <Fragment>
