                            ...
                            <div className={classes.back}>
                                <div className={classes.containerSuccess}>
                                    <div style={{ display: "flex", justifyContent: "center" }}>
                                        <img
                                            src={
                                                "https://publico-storage-01.s3.us-east.cloud-object-storage.appdomain.cloud/VCA%20PERU/dfbffeb9-5a11-4020-852d-a600264d8fb4/epayco-logo-fondo-oscuro.png"
                                            }
                                            style={{ height: 120, margin: "20px" }}
                                        />
                                    </div>
