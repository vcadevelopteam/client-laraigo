...
exports.CampaignPerson = function (_a) {
    var _b;
    var row = _a.row, edit = _a.edit, auxdata = _a.auxdata, detaildata = _a.detaildata, setDetaildata = _a.setDetaildata, multiData = _a.multiData, fetchData = _a.fetchData, frameProps = _a.frameProps, setFrameProps = _a.setFrameProps, setPageSelected = _a.setPageSelected, setSave = _a.setSave, idAux = _a.idAux, templateAux = _a.templateAux;
    ...
    var deleteSelectedRows = function () {
        var _a;
        var newJsonData = jsonData.filter(function (row) { return !selectedRows[row.campaignmemberid]; });
        setJsonData(newJsonData);
        setSelectedRows({});
        setDetaildata(__assign(__assign({}, detaildata), { jsonData: newJsonData, selectedRows: {}, person: (_a = detaildata.person) === null || _a === void 0 ? void 0 : _a.filter(function (person) { return !selectedRows[person.campaignmemberid]; }) }));
    };
    var handleDeleteSelectedRows = function () {
        var updatedJsonData = jsonData.filter(function (item) { return !selectedRows[item.Destinatarios]; });
    ...
    var adjustAndDownloadExcel = function (url) { return __awaiter(void 0, void 0, void 0, function () {
        var descriptionsMap, response, arrayBuffer, data, workbook, firstSheetName, worksheet, sheetData, columnNames, requiredVariableColumns, dynamicUrlButtons, dynamicUrlColumns, newColumnNames, newSheetData_1, newWorksheet, newWorkbook, wbout, error_1;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    requiredVariableColumns = templateAux.bodyvariables
                        ? templateAux.bodyvariables.map(function (varObj) { return "Variable " + varObj.variable; })
                        : [];
                    ...
                    newColumnNames = void 0;
                    if (templateAux.headertype === "TEXT") {
                        newColumnNames = __spreadArrays(columnNames.slice(0, 3), [
                            "Variable Cabecera"
                        ], columnNames.slice(3));
                    }
                    else {
                    ...
                    newColumnNames.forEach(function (columnName, index) {
                        ...
                        if (descriptionKey.startsWith("Variable Adicional")) {
                            ...
                            var variableNum = columnName.split(' ')[1];
    ...
    var handleUpload = function (files) {
        ...
        reader.onload = function (e) {
            ...
            setJsonData(deduplicatedRows.map(function (row) {
                var obj = {};
        ...
        if (detaildata.source === 'EXTERNAL') {
            return (react_1["default"].createElement(react_1["default"].Fragment, null,
                jsonData.length === 0 && (react_1["default"].createElement(react_1["default"].Fragment, null,
                    react_1["default"].createElement("a", { href: "#", onClick: function () { return adjustAndDownloadExcel(); }, style: { textDecoration: 'none' } },
