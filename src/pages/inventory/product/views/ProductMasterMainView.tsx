...
import { TemplateIcons, Title } from "components";
    ...
    return (
        ...
        >
            ...
            <TablePaginated
                ...
                FiltersElement={<div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}></div>}
            />
            <TemplateImportDialog openModal={openModalTemplate} setOpenModal={setOpenModalTemplate} />
            <ImportDialog
