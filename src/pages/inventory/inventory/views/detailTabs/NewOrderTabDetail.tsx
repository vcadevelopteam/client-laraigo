...
const NewOrderTabDetail: React.FC<NewOrderTabDetailProps> = ({fetchdata, errors, row, tabIndex,setValue,getValues}) => {
        ...
        <div className='col-6'>
          ...
          <div className='row-zyx'>
              <FieldCheckbox
                  ...
                  onChange={(value) => setValue("isneworder", value)}               
              />
          </div>
          <div className='row-zyx'>
              <FieldEdit
