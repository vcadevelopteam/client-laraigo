    ...
    return (
        <DialogZyx open={openModal} title={t(langKeys.deliveryphotoorder)} maxWidth="sm">
            <div className="row-zyx" style={{ gap: "1rem" }}>
                <FieldEdit label={t(langKeys.photo) + " 1 "} type="text" className="col-12" />
                <FieldEdit label={t(langKeys.photo) + " 2 "} type="text" className="col-12" />
                <FieldEdit label={t(langKeys.photo) + " 3 "} type="text" className="col-12" />
            </div>
