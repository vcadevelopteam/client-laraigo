...
const ElectronicTicketAndInvoiceDialog: React.FC<{
  ...
  return (
    <DialogZyx open={openModal} title={t(langKeys.electronic_ticket_and_invoice)} maxWidth="sm">
      ...
      <div style={{justifyContent: "left", display:"flex", paddingBottom:"1rem", gap:"2rem", margin:"0 4rem"}}>
        <Button                        
          variant="contained"
          color="primary"
          style={{ backgroundColor: "#55BD84", padding:"2rem 2rem"}}
        >
          <Trans i18nKey={t(langKeys.print) + " " + t(langKeys.y_o) + " " + t(langKeys.download) + " " + t(langKeys.receipt)} />
