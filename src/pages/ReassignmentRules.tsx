...
const DetailReassignmentRules: React.FC<DetailReassignmentRulesProps> = ({ data: { row, edit }, setViewSelected, multiData, fetchData,arrayBread }) => {
                ...
                <div className={classes.containerDetail}>
                    ...
                    <div className="row-zyx">
                        <FieldMultiSelect
                            ...
                            onChange={(value) => setValue('assignedgroup', value?.map((o: Dictionary) => o?.domainvalue||"").join())}
