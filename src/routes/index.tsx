...
const ChannelAddChatForm = lazy(() => import('pages/channels/ChannelAddChatForm'));
		...
		<Router basename={process.env.PUBLIC_URL}>
			<React.Suspense fallback={(
				...
				<Switch>
					...
					<ProtectRoute exact path={paths.CHANNELS_ADD_CHATFORM} component={() => (<Layout mainClasses={classes.main}><ChannelAddChatForm edit={false} /></Layout>)} />
					...
					<ProtectRoute exact path={paths.CHANNELS_EDIT_CHATFORM.path} component={() => (<Layout mainClasses={classes.main}><ChannelAddChatForm edit /></Layout>)} />
