...
import { Users, SignIn, Properties, Quickreplies, Groupconfig, Whitelist, InappropriateWords, IntelligentModels, SLA, Domains, Person, NotFound, Forbidden, InternalServererror, Supervisor, Tickets,
	Organizations, MessageTemplates, Tipifications, Channels, ChannelAdd, IntegrationManager, ChannelAddChatWeb, Reports, FlowDesigner, ChannelAddEnd } from 'pages';
	...
	return (
		<Router basename={process.env.PUBLIC_URL}>
			<Switch>
				...
				<ProtectRoute exact path={paths.CHANNELS_ADD_END.path}>
					<Layout mainClasses={classes.main}>
						<ChannelAddEnd />
					</Layout>
				</ProtectRoute>
