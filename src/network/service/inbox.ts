...
export function updateUserSettings({ oldpassword,password,confirmpassword,lastname,firstname,image, operation }: Dictionary) {
    const data = {
        oldpassword,password,confirmpassword,lastname,firstname,image, operation
    }
